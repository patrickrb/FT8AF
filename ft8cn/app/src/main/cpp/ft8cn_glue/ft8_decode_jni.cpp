...
//
// Java side:
//   com.bg7yoz.ft8cn.ft8listener.FT8SignalListener (instance methods)
//   com.bg7yoz.ft8cn.ft8listener.ReBuildSignal (static method)
...
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_InitDecoder(
...
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_DeleteDecoder(
...
// ---------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_DecoderMonitorPress(
...
// ---------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_DecoderMonitorPressFloat(
...
// ---------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_setDecodeMode(
...
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_DecoderFt8FindSync(
        JNIEnv*, jobject, jlong handle)
{
    ft8_decoder_state* d = (ft8_decoder_state*)(intptr_t)handle;
    if (!d || !d->mon_ready)
...
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_DecoderFt8Analysis(
...
// ---------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_DecoderFt8Reset(
...
Java_com_bg7yoz_ft8cn_ft8listener_FT8SignalListener_DecoderGetA91(
...
// ---------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ft8listener_ReBuildSignal_doSubtractSignal(
