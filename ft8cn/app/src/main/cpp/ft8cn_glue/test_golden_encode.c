...
// ft8cn_glue JNI layer). This test pins the *correct* output of the encode path
...
//   ft8cn/app/src/main/cpp/ft8cn_glue/run_host_tests.ps1
...
// FT8Package callsign-hash golden (the n22 from jni_ft8cn.cpp compute_n22; the
