...
//
// Java side:
//   com.bg7yoz.ft8cn.ui.SpectrumView    (instance methods)
//   com.bg7yoz.ft8cn.ui.SpectrumFragment (instance methods)
...
Java_com_bg7yoz_ft8cn_ui_SpectrumView_getFFTData(
...
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ui_SpectrumView_getFFTDataFloat(
...
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ui_SpectrumView_getFFTDataRaw(
        JNIEnv* env, jobject, jintArray data, jintArray fftData)
{
    jsize n = env->GetArrayLength(data);
    jint* in = env->GetIntArrayElements(data, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ui_SpectrumView_getFFTDataRawFloat(
        JNIEnv* env, jobject, jfloatArray data, jintArray fftData)
{
    jsize n = env->GetArrayLength(data);
    jfloat* in = env->GetFloatArrayElements(data, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ui_SpectrumFragment_getFFTData(
        JNIEnv* env, jobject, jintArray data, jintArray fftData)
{
    jsize n = env->GetArrayLength(data);
    jint* in = env->GetIntArrayElements(data, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ui_SpectrumFragment_getFFTDataFloat(
        JNIEnv* env, jobject, jfloatArray data, jintArray fftData)
{
    jsize n = env->GetArrayLength(data);
    jfloat* in = env->GetFloatArrayElements(data, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ui_SpectrumFragment_getFFTDataRaw(
        JNIEnv* env, jobject, jintArray data, jintArray fftData)
{
    jsize n = env->GetArrayLength(data);
    jint* in = env->GetIntArrayElements(data, nullptr);
...
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ui_SpectrumFragment_getFFTDataRawFloat(
        JNIEnv* env, jobject, jfloatArray data, jintArray fftData)
{
    jsize n = env->GetArrayLength(data);
    jfloat* in = env->GetFloatArrayElements(data, nullptr);
