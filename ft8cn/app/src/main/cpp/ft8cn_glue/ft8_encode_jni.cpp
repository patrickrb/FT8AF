...
// (pinned at 6f528128) and the ft8cn_glue GFSK synthesizer.
//
// Java side: com.bg7yoz.ft8cn.ft8transmit.GenerateFT8
...
// Declared in ft8cn_glue/gfsk.c (no separate header).
...
Java_com_bg7yoz_ft8cn_ft8transmit_GenerateFT8_pack77(
...
// ---------------------------------------------------------------------------
extern "C" JNIEXPORT jint JNICALL
Java_com_bg7yoz_ft8cn_ft8transmit_GenerateFT8_packFreeTextTo77(
        JNIEnv* env, jclass, jstring msg, jbyteArray c77)
{
    const char* msg_c = env->GetStringUTFChars(msg, nullptr);
    if (!msg_c) return -1;
...
Java_com_bg7yoz_ft8cn_ft8transmit_GenerateFT8_ft8_1encode(
...
// ---------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_com_bg7yoz_ft8cn_ft8transmit_GenerateFT8_synth_1gfsk(
        JNIEnv* env, jclass,
